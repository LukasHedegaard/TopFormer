...
class IMaterialistFastion3Dataset(CustomDataset):
    """ADE20K dataset.

    In segmentation map annotation for iMaterialist Fashion, 0 stands for background, which
    is not included in 45 categories. ``reduce_zero_label`` is fixed to True.
    ...
    def __init__(self, **kwargs):
        super(IMaterialistFastion3Dataset, self).__init__(
